...
| Vector storage | [`VectorStore`](src/ragkit/ports/interfaces.py) | [`InMemoryVectorStore`](src/ragkit/adapters/retrieval.py), [`SQLiteVectorStore`](src/ragkit/adapters/sqlite_store.py) | [Bootstrap](src/ragkit/infrastructure/bootstrap.py), `components.vector_store` | [Vector-store contract/integration](tests/integration/test_sqlite_store.py) |
